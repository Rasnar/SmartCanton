/**
 * @file    app_preinclude.c
 * @author  Da Silva Andrade David
 * @version V1.0
 * @date    02-01-2018
 * @brief	File defining the application configuration. Here we define what kind of 
 *          features we want to enable on the Os Abstraction Layer from freescale.
 *          We also define the MAC address and passkey on the BLE device.
 */
