...
PRIMARY_SERVICE_UUID128(service_smartcanton_devbox, uuid_service_smartcanton_devbox)
	...
	CHARACTERISTIC_UUID128(char_lora_app_key, uuid_lora_app_key, (gGattCharPropRead_c | gGattCharPropWrite_c))
		VALUE_UUID128_VARLEN(value_lora_app_key, uuid_lora_app_key, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 23, 23, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)
	...
	CHARACTERISTIC_UUID128(char_lora_device_eui, uuid_lora_device_eui, (gGattCharPropRead_c))
		VALUE_UUID128_VARLEN(value_lora_device_eui, uuid_lora_device_eui, (gPermissionFlagReadable_c), 23, 23, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)
	...
	CHARACTERISTIC_UUID128(char_lora_device_address, uuid_lora_device_address, (gGattCharPropRead_c))
		VALUE_UUID128_VARLEN(value_lora_device_address, uuid_lora_device_address, (gPermissionFlagReadable_c), 23, 23, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)
	...
	CHARACTERISTIC_UUID128(char_lora_network_session_key, uuid_lora_network_session_key, (gGattCharPropRead_c))
		VALUE_UUID128_VARLEN(value_lora_network_session_key, uuid_lora_network_session_key, (gPermissionFlagReadable_c), 23, 23, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)
	...
	CHARACTERISTIC_UUID128(char_lora_app_session_key, uuid_lora_app_session_key, (gGattCharPropRead_c))
		VALUE_UUID128_VARLEN(value_lora_app_session_key, uuid_lora_app_session_key, (gPermissionFlagReadable_c), 23, 23, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)
