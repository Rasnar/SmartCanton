...
// TODO : This attribute has been remove has an indication because we need one last CCCD. We put it as a readable characteristic. Can be restored on other application.
...
//        CCCD(cccd_service_changed)
	CHARACTERISTIC(char_service_changed, gBleSig_GattServiceChanged_d, (gGattCharPropIndicate_c))
		VALUE(value_service_changed, gBleSig_GattServiceChanged_d, (gPermissionFlagReadable_c), 4, 0x00, 0x00, 0x00, 0x00)
		CCCD(cccd_service_changed)
...
PRIMARY_SERVICE_UUID128(service_smartcanton_devbox_bme680, uuid_service_smartcanton_devbox_bme680)
	CHARACTERISTIC_UUID128(char_bme680_iaq, uuid_bme680_iaq, (gGattCharPropNotify_c))
		VALUE_UUID128(value_bme680_iaq, uuid_bme680_iaq, (gPermissionFlagReadable_c), 4, 0x00, 0x00, 0x00, 0x00)
	...
	CHARACTERISTIC_UUID128(char_bme680_iaq_accuracy, uuid_bme680_iaq_accuracy, (gGattCharPropNotify_c))
		VALUE_UUID128(value_bme680_iaq_accuracy, uuid_bme680_iaq_accuracy, (gPermissionFlagReadable_c), 1, 0x00)
	...
	CHARACTERISTIC_UUID128(char_bme680_temperature, uuid_bme680_temperature, (gGattCharPropNotify_c))
		VALUE_UUID128(value_bme680_temperature, uuid_bme680_temperature, (gPermissionFlagReadable_c), 4, 0x00, 0x00, 0x00, 0x00)
	...
	CHARACTERISTIC_UUID128(char_bme680_humidity, uuid_bme680_humidity, (gGattCharPropNotify_c))
		VALUE_UUID128(value_bme680_humidity, uuid_bme680_humidity, (gPermissionFlagReadable_c), 4, 0x00, 0x00, 0x00, 0x00)
	...
	CHARACTERISTIC_UUID128(char_bme680_pressure, uuid_bme680_pressure, (gGattCharPropNotify_c))
		VALUE_UUID128(value_bme680_pressure, uuid_bme680_pressure, (gPermissionFlagReadable_c), 4, 0x00, 0x00, 0x00, 0x00)
	...
	CHARACTERISTIC_UUID128(char_bme680_raw_gas, uuid_bme680_raw_gas, (gGattCharPropNotify_c))
		VALUE_UUID128(value_bme680_raw_gas, uuid_bme680_raw_gas, (gPermissionFlagReadable_c), 4, 0x00, 0x00, 0x00, 0x00)
	...
	CHARACTERISTIC_UUID128(char_bme680_raw_temperature, uuid_bme680_raw_temperature, (gGattCharPropRead_c))
		VALUE_UUID128(value_bme680_raw_temperature, uuid_bme680_raw_temperature, (gPermissionFlagReadable_c), 4, 0x00, 0x00, 0x00, 0x00)
	...
	CHARACTERISTIC_UUID128(char_bme680_raw_humidity, uuid_bme680_raw_humidity, (gGattCharPropRead_c))
		VALUE_UUID128(value_bme680_raw_humidity, uuid_bme680_raw_humidity, (gPermissionFlagReadable_c), 4, 0x00, 0x00, 0x00, 0x00)
...
PRIMARY_SERVICE_UUID128(service_smartcanton_devbox_bno055, uuid_service_smartcanton_devbox_bno055)
	CHARACTERISTIC_UUID128(char_bno055_accelerometer, uuid_bno055_accelerometer, (gGattCharPropNotify_c))
		VALUE_UUID128_VARLEN(value_bno055_accelerometer, uuid_bno055_accelerometer, (gPermissionFlagReadable_c), 20, 12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)
	...
	CHARACTERISTIC_UUID128(char_bno055_gyroscope, uuid_bno055_gyroscope, (gGattCharPropNotify_c))
		VALUE_UUID128_VARLEN(value_bno055_gyroscope, uuid_bno055_gyroscope, (gPermissionFlagReadable_c), 20, 12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)
	...
	CHARACTERISTIC_UUID128(char_bno055_magnetometer, uuid_bno055_magnetometer, (gGattCharPropNotify_c))
		VALUE_UUID128_VARLEN(value_bno055_magnetometer, uuid_bno055_magnetometer, (gPermissionFlagReadable_c), 20, 12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00)
