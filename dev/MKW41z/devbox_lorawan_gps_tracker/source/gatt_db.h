...
PRIMARY_SERVICE_UUID128(service_smartcanton_devbox_gps, uuid_service_smartcanton_devbox_gps)
	CHARACTERISTIC_UUID128(char_gps_latitude, uuid_gps_latitude, (gGattCharPropIndicate_c |gGattCharPropRead_c))
		VALUE_UUID128(value_gps_latitude, uuid_gps_latitude, (gPermissionFlagReadable_c), 4, 0x00, 0x00, 0x00, 0x00)
		DESCRIPTOR(descriptor_gps_latitude, 0x2901, (gPermissionFlagReadable_c), 13, "GPS Lattitude")
		CCCD(cccd_gps_latitude)
	CHARACTERISTIC_UUID128(char_gps_longitude, uuid_gps_longitude, (gGattCharPropIndicate_c |gGattCharPropRead_c))
		VALUE_UUID128(value_gps_longitude, uuid_gps_longitude, (gPermissionFlagReadable_c), 4, 0x00, 0x00, 0x00, 0x00)
		DESCRIPTOR(descriptor_gps_longitude, 0x2901, (gPermissionFlagReadable_c), 13, "GPS Longitude")
		CCCD(cccd_gps_longitude)
	CHARACTERISTIC_UUID128(char_gps_speed, uuid_gps_speed, (gGattCharPropIndicate_c |gGattCharPropRead_c))
		VALUE_UUID128(value_gps_speed, uuid_gps_speed, (gPermissionFlagReadable_c), 4, 0x00, 0x00, 0x00, 0x00)
		DESCRIPTOR(descriptor_gps_speed, 0x2901, (gPermissionFlagReadable_c), 9, "GPS Speed")
		CCCD(cccd_gps_speed)
	CHARACTERISTIC_UUID128(char_gps_course, uuid_gps_course, (gGattCharPropIndicate_c |gGattCharPropRead_c))
		VALUE_UUID128(value_gps_course, uuid_gps_course, (gPermissionFlagReadable_c), 4, 0x00, 0x00, 0x00, 0x00)
		DESCRIPTOR(descriptor_gps_course, 0x2901, (gPermissionFlagReadable_c), 10, "GPS Course")
		CCCD(cccd_gps_course)
	CHARACTERISTIC_UUID128(char_gps_date, uuid_gps_date, (gGattCharPropIndicate_c |gGattCharPropRead_c))
		VALUE_UUID128_VARLEN(value_gps_date, uuid_gps_date, (gPermissionFlagReadable_c), 23, 3, "GPS Date")
		DESCRIPTOR(descriptor_gps_date, 0x2901, (gPermissionFlagReadable_c), 8, "GPS Date")
		CCCD(cccd_gps_date)
	CHARACTERISTIC_UUID128(char_gps_time, uuid_gps_time, (gGattCharPropIndicate_c |gGattCharPropRead_c))
		VALUE_UUID128_VARLEN(value_gps_time, uuid_gps_time, (gPermissionFlagReadable_c), 23, 3, "GPS Time")
